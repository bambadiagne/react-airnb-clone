  ...
  const handleSubmit = async (e) => {
    ...
    if (validateuserData(updateUserData)) {
      ...
      if (profile === "locataire") {
        ...
        try {
          const res = await TenantService.UpdateSingleTenant(
            currentUser.id,
            user
          );
        ...
        try {
          const res = await LandlordService.UpdateSingleLandLord(
            currentUser.id,
            user
          );
          console.log("eere", res);
  ...
  const updateBalance = (e) => {
    ...
    if (!userBalance) {
      ...
      try {
        ...
        const res = TenantService.UpdateSingleTenant(currentUser.id, {
          ...currentUser,
          balance: newBalance,
        });
            ...
            <div style={{ backgroundColor: "#f2f3f7" }}>
              ...
              <div>
                <h4 className="text-center">
                  Profile : <span>{user.profile}</span>{" "}
                </h4>
                <br />
                <br />
                ...
                <div
                  hidden={user.profile === "locateur"}
                  className="center-block  card text-white bg-primary mb-3 justify-content-center"
                  style={{ width: "80%" }}
                >
                  <div
                    hidden={!successful.updateBalance}
                  ...
                  <div>
                    <form onSubmit={updateBalance}>
                      ...
                      <div className="form-group ">
                        ...
                        >
                          Ajouter{" "}
                          <FontAwesomeIcon key={"plane2"} icon={faPlusCircle} />
                        </button>
                      </div>
                    </form>
                  </div>
                ...
                <div
                  hidden={user.profile === "locataire"}
                  className="center-block rounded-lg card text-white bg-primary mb-3 justify-content-center"
                  style={{ width: "80%" }}
                >
                  <div className="card-header">
                    <FontAwesomeIcon
