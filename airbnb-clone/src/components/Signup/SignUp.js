...
import { SIGN_UP_SUCCESS_ACTION, SIGN_UP_FAIL_ACTION } from '../../actions/auth/types';
function SignUp({ signUpDispatch }) {
    ...
    function validateuserData(signup) {
        const errorsForm = [];
        const { first_name, last_name, confirmationPassword, mail_address, gender, password, profile, birth_date } = signup;
        if (!gender) {
    ...
    const handleSubmit = async e => {
        ...
        if (validateuserData(signupData)) {
            ...
            setSignupData({ ...signupData, birth_date: birth_date.toISOString().split('T')[0] })
    ...
    return <div className="signup-form ">
        ...
        <form onSubmit={handleSubmit} ><br />
            ...
            <div hidden={!successful} className="alert alert-success" role="alert">
                Compte créé avec succès !</div>
            <h2>Inscription</h2>
            ...
            <div className="form-group input-container">
                ...
                <TDatePicker selected={signupData.birth_date} setStartDate={setStartDate} className="form-control " />
            </div>
            ...
            <div className="form-group ">
                ...
                <button  type="submit" className="col-12 btn btn-primary btn-lg btn-block">  <FontAwesomeIcon key={"plane1"} icon={faPaperPlane} style={{ "float": 'left' }} />
                    S'inscrire  <FontAwesomeIcon key={"plane2"} icon={faPaperPlane} style={{ "float": 'right' }} /></button>
